        ...
        if pager['previous_page'] || pager['next_page']
            ...
            if pager['previous_page']
                ...
                if pager['previous_page'] == 1
                    html << "<span class=\"previous\"><a href=\"/#{pager['category']}/\">&laquo; Newer posts</a></span>"
                else
                    html << "<span class=\"previous\"><a href=\"/#{pager['category']}/page#{pager['previous_page']}\">&laquo; Newer posts</a></span>"
                end

            end

            if pager['next_page']
                html << "<span class=\"next\"><a href=\"/#{pager['category']}/page#{pager['next_page']}\">Older posts &raquo;</a></span>"
            end
